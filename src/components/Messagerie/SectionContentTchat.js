...
export default class SectionContentTchat extends Component {
    ...
    componentDidMount(){
        ...
        .then(res => {
            ...
            //Recuperation de l'avatar + nom + prenom
            axios.get('http://149.91.89.142:8000/api/users/' + idUserAutre)
            .then(res => {
                this.setState({
    ...
    sendMessage(){
        ...
        axios.post('http://149.91.89.142:8000/api/messageries', {idSalon: this.props.idContent, idUser: localStorage.getItem('ID')*1, message: this.state.myMessage, dateMsg: getDateTime()})
        .then(res => {
    ...
    swapAccepted(){
        ...
        axios.put('http://149.91.89.142:8000/api/swaps/' + this.state.swapEnCours, {
            ...
            headers: {
                ...
                axios.post('http://149.91.89.142:8000/api/messageries', {idSalon: this.props.idContent, idUser: localStorage.getItem('ID')*1, message: "Swap accepté, laissez un avis sur la page l'annonce", dateMsg: getDateTime()})
                .then(res => {
    ...
    swapRefuse(){
        ...
        headers: {
            ...
            axios.post('http://149.91.89.142:8000/api/messageries', {idSalon: this.props.idContent, idUser: localStorage.getItem('ID')*1, message: "Swap refusé", dateMsg: getDateTime()})
            .then(res => {
