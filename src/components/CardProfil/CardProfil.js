...
export default class CardProfil extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost:8000/api/categories/' + this.props.categorieEnvoi)
            .then(res => {
        ...
        return (
            <div > 
                <section data-type={this.props.typeAnnonce} className={"search-result-item border"}>
                        ...
                        <img className="image-annonce image-link" src={"http://localhost:8000/uploads/annonces/" + this.props.photoAnnonce} alt={this.props.photoAnnonce}/>
