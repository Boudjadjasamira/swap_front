    ...
    render() {
        return (
            <div className="body" id="bodyHome">
                ...
                &nbsp;
                <span>
                                                    <Link to={process.env.PUBLIC_URL + "/Invite"}> Parainnage</Link>
                                                </span>
                                                <br />
                                                <svg
                                                    width="1em"
                                            ...
                                            <div className="media border p-3 flex-column flex-md-row">
                                                <div className="media-body align-self-center">
                                                    ...
                                                    <p>
                                                        ...
                                                        euismod, neque id auctor laoreet, urna velit tempor ipsum,
                                                        sed posuere elit nibh sit amet massa. Maecenas sed ipsum id
                                                        felis molestie dapibus a nec risus. Proin auctor dui eu
                                                        sagittis facilisis. Sed a viverra mi. Morbi nisl sapien,
                                                        vulputate sit amet blandit eget, auctor nec libero. Duis
                                                        rutrum viverra augue at efficitur. Fusce massa tortor,
                                                        tempus ut scelerisque eget, blandit sit amet risus. Aliquam
                                                        commodo ut velit vestibulum condimentum. Aenean nisi mauris,
                                                        finibus eget euismod ac, porta a nisi. Suspendisse mattis et
                                                        est non bibendum. Ut dolor mauris, fermentum nec pretium ac,
                                                        finibus sed nunc. Nunc et imperdiet ante. Praesent et quam
                                                        neque. Sed maximus et neque eu vulputate.
                                                    </p>
                                                    <br />
